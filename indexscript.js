...
function init() {
    ...
    if(document.getElementById("searchbar").value == ""){
      document.getElementById("txtSrchBtn").disabled = true;
      txtSrchBtn.classList.remove("disabled");
    }

    document.getElementById("txtSrchBtn").classList.add("disabled");
    document.getElementById("txtSrchBtn").classList.remove("btnBackground:hover");
